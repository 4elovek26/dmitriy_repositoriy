...
switch($foods[$foodItem]){
    ...
    case $foods[2]:
    case $foods[5]:
        echo 'Выбранный продукт '. $foods[$foodItem] .' - это '. $foodType[1] . "<br>";
        break;
    case $foods[1]:
    case $foods[6]:
         echo 'Выбранный продукт '. $foods[$foodItem] .' - это '. $foodType[0] . "<br>";
         break;
    case $foods[3]:
    case $foods[4]:
    case $foods[7]:
        echo 'Выбранный продукт '. $foods[$foodItem] .' - это '. $foodType[2] . "<br>";
        break;
    case $foods[8]:
        echo 'Выбранный продукт '. $foods[$foodItem] .' - это '. $foodType[3] . "<br>";
        break;
}
